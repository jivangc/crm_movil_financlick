...
data class EmpresaModelSave (
    ...
    @SerializedName("fechaConstitucion") val fechaConstitucion: String? = null,
    ...
    @SerializedName("fechaInscripcion") val fechaInscripcion: String? = null,
